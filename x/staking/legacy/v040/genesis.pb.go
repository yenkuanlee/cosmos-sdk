...
// https://github.com/yenkuanlee/cosmos-sdk/blob/v0.40.1/x/staking/types/genesis.pb.go
...
import (
	...
	github_com_cosmos_cosmos_sdk_types "github.com/yenkuanlee/cosmos-sdk/types"
...
type GenesisState struct {
	...
	LastTotalPower github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,2,opt,name=last_total_power,json=lastTotalPower,proto3,customtype=github.com/yenkuanlee/cosmos-sdk/types.Int" json:"last_total_power" yaml:"last_total_power"`
