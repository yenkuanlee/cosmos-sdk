...
import (
	...
	github_com_tendermint_tendermint_libs_bytes "github.com/yenkuanlee/tendermint/libs/bytes"
...
type QueryEvidenceRequest struct {
	...
	EvidenceHash github_com_tendermint_tendermint_libs_bytes.HexBytes `protobuf:"bytes,1,opt,name=evidence_hash,json=evidenceHash,proto3,casttype=github.com/yenkuanlee/tendermint/libs/bytes.HexBytes" json:"evidence_hash,omitempty"`
}
