...
type TxBody struct {
	...
	// but should be called `note` instead (see https://github.com/yenkuanlee/cosmos-sdk/issues/9122).
...
type Fee struct {
	...
	Amount github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,1,rep,name=amount,proto3,castrepeated=github.com/yenkuanlee/cosmos-sdk/types.Coins" json:"amount"`
