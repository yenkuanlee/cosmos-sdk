...
func trimInternal(st errors.StackTrace) errors.StackTrace {
	...
	for matchesFunc(st[0],
		...
		"github.com/yenkuanlee/cosmos-sdk/types/errors.Wrap",
		"github.com/yenkuanlee/cosmos-sdk/types/errors.Wrapf",
		"github.com/yenkuanlee/cosmos-sdk/types/errors.WithType",
